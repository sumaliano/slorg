...
#define SMODKEY (Mod1Mask | ShiftMask)
...
MouseKey mkeys[] = {
    ...
    { Button4,              TERMMOD,        kscrollup,      { .i = 1 } },
    { Button5,              TERMMOD,        kscrolldown,    { .i = 1 } },
};

static char *openurlcmd[] = { "linkgrabber.sh", "externalpipe", NULL };
static char *editscreencmd[] = { "editscreen.sh", "externalpipe", NULL };
