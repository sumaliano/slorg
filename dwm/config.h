...
static const char *fonts[]          = { "monospace:size=12","Fira Mono:style=Regular:size=12" };
static const char dmenufont[]       = "monospace:size=12";
static const char stFont[]          = "Fira Mono:style=Regular:size=12" ;
static const char stTitle[]         = "Suckless Terminal";
...
static const char *termcmd[]  = { "st", "-t", stTitle, "-f", stFont  };

static Key keys[] = {
	/* modifier                     key        function        argument */
	{ MODKEY,                       XK_o,      spawn,          {.v = j4dmenucmd } },
